...
public class User_ReferChef extends BaseActivity2 {
	private String[] navMenuTitles;
	private TypedArray navMenuIcons;
	private final static String TAG = User_ReferChef.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.user_referchef);
	...
	class AttemptLogin extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			...
			super.onPreExecute();
			pDialog = new ProgressDialog(User_ReferChef.this);
		...
		protected String doInBackground(String... params) {
			...
			try {
				...
				JSONObject json = jsonParser.makeHttpRequest(
						"http://momsdhaba.com/mobileapp/referchef/", "POST",
						paramter);
				...
				try {
					...
					if (result.equals("success")) {
						...
						Intent i = new Intent(User_ReferChef.this,
								User_ReferChef.class);
						finish();
						startActivity(i);
					}
	...
	public void alertdialog() {
		runOnUiThread(new Runnable() {
			public void run() {
				// If there are stories, add them to the table
				alertDialog = new AlertDialog.Builder(User_ReferChef.this)
						.create();
